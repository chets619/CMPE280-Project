    ...
    return (
        <Fragment>
            <div class="bg-light fire-bg">
                <div class="container py-5">
                    <div class="row h-100 align-items-center py-5">
                        <div class="col-lg-6">
                            <h1 class="display-4">{t("Wildfires")}:</h1>
                            <p class="lead mb-0">{t("AboutDesc")}</p>
                        </div>
            ...
            <div class="bg-white py-5">
                <div class="container py-5">
                    <h2 className="display-4">{t("Stats")}</h2>
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-6"><i class="fa fa-leaf fa-2x mb-3 text-primary"></i>
                            <h2 class="font-weight-light">{t("Who are we")}</h2>
                            <p class="font-italic text-muted mb-4">{t("WhoDesc")}</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-light py-5">
                <div class="container py-5">
                    <div class="row mb-4">
                        <div class="col-lg-8">
                            <h2 class="display-4 font-weight-light">{t("Team")}</h2>
                            <p class="font-italic text-muted">{t("TeamDesc")}</p>
                        </div>
                    </div>
                    ...
                    <div class="row text-center">
                        <div class="col-xl-3 col-sm-6 mb-5">
                            <div class="bg-white rounded shadow-sm py-5 px-4"><img src="https://res.cloudinary.com/mhmd/image/upload/v1556834130/avatar-3_hzlize.png" alt="" width="100" class="img-fluid rounded-circle mb-3 img-thumbnail shadow-sm" />
                                <h5 class="mb-0">Srinivas Anudeep Chitta</h5><span class="small text-uppercase text-muted">{t("SoftDev")}</span>
                            </div>
                        </div>
                        <div class="col-xl-3 col-sm-6 mb-5">
                            <div class="bg-white rounded shadow-sm py-5 px-4"><img src="https://res.cloudinary.com/mhmd/image/upload/v1556834133/avatar-2_f8dowd.png" alt="" width="100" class="img-fluid rounded-circle mb-3 img-thumbnail shadow-sm" />
                                <h5 class="mb-0">Priyam Vaidya</h5><span class="small text-uppercase text-muted">{t("SoftDev")}</span>
                            </div>
                        </div>
                        <div class="col-xl-3 col-sm-6 mb-5">
                            <div class="bg-white rounded shadow-sm py-5 px-4"><img src="https://res.cloudinary.com/mhmd/image/upload/v1556834133/avatar-1_s02nlg.png" alt="" width="100" class="img-fluid rounded-circle mb-3 img-thumbnail shadow-sm" />
                                <h5 class="mb-0">Chaitanya Naik</h5><span class="small text-uppercase text-muted">{t("SoftDev")}</span>
                            </div>
                        </div>
